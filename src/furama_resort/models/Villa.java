...
public class Villa extends Facility{
    ...
    public Villa(String nameService, Double useArea, Double rentalCost, int maxPerson, String typeOfRental, String roomStandard, Double swimmingPoolAarea, int numberOfFloors) {
